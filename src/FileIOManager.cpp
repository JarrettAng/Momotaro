...
namespace FileIOManager {
	void ReadBuildingsData(std::vector<BuildingData>& buildingsData) {
		...
		BuildingData newBuilding2{ BuildingEnum::RESIDENTIAL, BuildingEnum::_1X1, BuildingEnum::L2, 1, 3, -3, 2, "Terrace house", "Bigger lovelier house", 001, 000 };
		buildingsData.push_back(newBuilding2);
		BuildingData newBuilding3{ BuildingEnum::RESIDENTIAL, BuildingEnum::_1X1, BuildingEnum::L3, 1, 3, -3, 2, "Big house", "Biggest loveliest house", 002, 000 };
		...
		BuildingData newBuilding7{ BuildingEnum::COMMERCIAL, BuildingEnum::_1X1, BuildingEnum::L1, 3, -1, -1, 1, "Street Stall", "Can use your CDC vouchers here", 100, 000 };
		buildingsData.push_back(newBuilding7);
		BuildingData newBuilding8{ BuildingEnum::COMMERCIAL, BuildingEnum::_1X1, BuildingEnum::L2, 3, -1, -1, 1, "Small Shop", "Lovely shop with lovely goods", 101, 000 };
		buildingsData.push_back(newBuilding8);
		BuildingData newBuilding9{ BuildingEnum::COMMERCIAL, BuildingEnum::_1X1, BuildingEnum::L3, 3, -1, -1, 1, "Big Shophouse", "Big shophouse which sells many goods", 102, 000 };
		...
		BuildingData newBuilding13{ BuildingEnum::INDUSTRIAL, BuildingEnum::_1X1, BuildingEnum::L1, -3, -1, 5, 1, "Storage Lot", "Small lot to store some goods", 200, 000 };
		buildingsData.push_back(newBuilding13);
		BuildingData newBuilding14{ BuildingEnum::INDUSTRIAL, BuildingEnum::_1X1, BuildingEnum::L2, -3, -1, 5, 1, "Small Warehouse", "Bigger warehouse to store even more goods", 201, 000 };
		buildingsData.push_back(newBuilding14);
		BuildingData newBuilding15{ BuildingEnum::INDUSTRIAL, BuildingEnum::_1X1, BuildingEnum::L3, -3, -1, 5, 1, "Big Warehouse", "Big enough to fit 2 IKEAs inside", 202, 000 };
